...
<body class="backdark">
        ...
        <div class="row">
            <div class="col-md-12 text-white">
                ...
                <form method="post" class="my-3 table-bordered border-primary" action='<?php echo constant('URL'); ?>agregarCampos/activarCampos'>
                    <h3 class="card-title col mb-3 text-center">Gestion de Campos dinamicos "Caracteristicas" Productos</h3>
        ...
        <div class="row">
            <div class="col-md-12 text-white">
                <form class="my-3 table-bordered border-primary" action='<?php echo constant('URL'); ?>agregarCampos/agregarCampos' method="post">
                    <h3 class="card-title col mb-3 text-center">Alta de Campo Dinamico Productos</h3>
        ...
        <div class="row">
            <div class="col-md-12 text-white">
                ...
                <form method="post" class="my-3 table-bordered border-primary" action='<?php echo constant('URL'); ?>agregarCampos/activarProducto'>
                    <h3 class="card-title col mb-3 text-center">Cambiar de estado el Producto</h3>
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- ALTA COMENTARIO PRODUCTO -->

            <div class="col-md-12 text-white">
                <form class="my-3 table-bordered border-primary" action='<?php echo constant('URL'); ?>agregarCampos/agregarCamposComentarios' method="post">
                    <h3 class="card-title col mb-3 text-center">Alta de Campo Dinamico Comentarios</h3>
